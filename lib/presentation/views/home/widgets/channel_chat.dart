                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      String formattedDate = chatDateHeader(data.dateTime!);
                      String timeWithDate = kChannelMessageFormater(data.dateTime!);
                            
                      // Determine if a date header is needed
                      bool showHeader = index == 0 || chatDateHeader(state.chat[index - 1].dateTime!) != formattedDate;
                          ...
                          ListTile(
                            ...
                            title: Row(
                              children: [
                                Text(data.userName!),
                                kWidth10,
                                Text(timeWithDate, style: const TextStyle(fontSize: 13, color: kClrGrey)),
                              ],
                            ),
                            subtitle: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,

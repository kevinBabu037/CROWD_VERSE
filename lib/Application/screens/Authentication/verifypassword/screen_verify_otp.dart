...
import '../restpassword/screen_reset_pass.dart';
import 'widgets/otp_textform_widget.dart';

class ScreenVerifyPassword extends StatelessWidget {
   ScreenVerifyPassword({super.key, required this.token});
   final String token;
